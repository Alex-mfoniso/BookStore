import { Routes, Route, useLocation, Navigate } from "react-router-dom"; // Added Navigate for redirection
...
const App = () => {
  ...
  return (
    <>
      <ToastContainer /> {/* Add ToastContainer for global notifications */}
